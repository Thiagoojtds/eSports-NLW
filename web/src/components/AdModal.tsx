...
export function AdModal() {
    ...
    async function handleCreatedAt(event : React.FormEvent) {
    ...
    return (
        <Dialog.Portal>
          <Dialog.Overlay className='bg-black/60 inset-0 fixed'>
            <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1 left-1/2 -translate-x-1/2 -translant-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/15'>
